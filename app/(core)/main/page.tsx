      ...
      <div className="w-full rounded-t-3xl border-t border-blue-light-200 bg-background p-6 shadow-[0px_4px_15px_blue-light-200] flex flex-col justify-between h-[65vh] flex-shrink-0 relative">
        ...
        <div className="mt-2 h-[214px]" /> 
          ...
          <button
            ...
            className={`
              absolute flex h-[50px] w-[108px] items-center justify-center gap-2 rounded-[100px] border border-blue-light-100 bg-background text-caption font-medium text-gray-3 transition-all duration-300 hover:bg-blue-light-100 left-[20px] ${isKeyboardOpen ? 'top-[75%]' : 'top-[25%]'}`}
          >
            <Image
          ...
          <button
            ...
            disabled={isLoading}
            className={`absolute flex h-[50px] items-center justify-center gap-2 rounded-[100px] border border-blue-light-100 bg-blue-light-100 text-caption font-medium text-primary-light transition-all duration-300 hover:bg-blue-light-200 disabled:opacity-70 disabled:bg-gray-2 right-[16px] ${isKeyboardOpen ? 'top-[70%]' : 'top-[43%]'}`}
            style={{
